...
// lower level.
bool MemMgr::DemoteOldPermanentSpaces(unsigned hierarchy)
{
...
bool MemMgr::PromoteNewExportSpaces(unsigned hierarchy)
{
...
{
    return DemoteOldPermanentSpaces(1); // Only truly permanent spaces are retained.
}
