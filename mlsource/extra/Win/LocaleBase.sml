...
struct
    ...
    in
        ...
        local
            val tab = [
            (LANG_NEUTRAL, 0wx00),
            (LANG_AFRIKAANS, 0wx36),
            (LANG_ALBANIAN, 0wx1c),
            (LANG_ARABIC, 0wx01),
            (LANG_BASQUE, 0wx2d),
            (LANG_BELARUSIAN, 0wx23),
            (LANG_BULGARIAN, 0wx02),
            (LANG_CATALAN, 0wx03),
            (LANG_CHINESE, 0wx04),
            (LANG_CROATIAN, 0wx1a),
            (LANG_CZECH, 0wx05),
            ...
            (LANG_GREEK, 0wx08),
            (LANG_HEBREW, 0wx0d),
            (LANG_HUNGARIAN, 0wx0e),
            (LANG_ICELANDIC, 0wx0f),
            (LANG_INDONESIAN, 0wx21),
            (LANG_ITALIAN, 0wx10),
            (LANG_JAPANESE, 0wx11),
            (LANG_KOREAN, 0wx12),
            (LANG_LATVIAN, 0wx26),
            (LANG_LITHUANIAN, 0wx27),
            (LANG_NORWEGIAN, 0wx14),
            (LANG_POLISH, 0wx15),
            (LANG_PORTUGUESE, 0wx16),
            (LANG_ROMANIAN, 0wx18),
            (LANG_RUSSIAN, 0wx19),
            (LANG_SERBIAN, 0wx1a),
            (LANG_SLOVAK, 0wx1b),
            (LANG_SLOVENIAN, 0wx24),
            (LANG_SPANISH, 0wx0a),
            (LANG_SWEDISH, 0wx1d),
            (LANG_THAI, 0wx1e),
            (LANG_TURKISH, 0wx1f),
            (LANG_UKRANIAN, 0wx22),
            (LANG_VIETNAMESE, 0wx2a)]
        in
        ...
        local
            val tab = [
            (SUBLANG_NEUTRAL, 0wx00),
            (SUBLANG_DEFAULT, 0wx01),
            (SUBLANG_SYS_DEFAULT, 0wx02),
            (SUBLANG_ARABIC_SAUDI_ARABIA, 0wx01),
            (SUBLANG_ARABIC_IRAQ, 0wx02),
            (SUBLANG_ARABIC_EGYPT, 0wx03),
            (SUBLANG_ARABIC_LIBYA, 0wx04),
            (SUBLANG_ARABIC_ALGERIA, 0wx05),
            (SUBLANG_ARABIC_MOROCCO, 0wx06),
            (SUBLANG_ARABIC_TUNISIA, 0wx07),
            (SUBLANG_ARABIC_OMAN, 0wx08),
            (SUBLANG_ARABIC_YEMEN, 0wx09),
            (SUBLANG_ARABIC_SYRIA, 0wx0a),
            (SUBLANG_ARABIC_JORDAN, 0wx0b),
            (SUBLANG_ARABIC_LEBANON, 0wx0c),
            (SUBLANG_ARABIC_KUWAIT, 0wx0d),
            (SUBLANG_ARABIC_UAE, 0wx0e),
            (SUBLANG_ARABIC_BAHRAIN, 0wx0f),
            (SUBLANG_ARABIC_QATAR, 0wx10),
            (SUBLANG_CHINESE_TRADITIONAL, 0wx01),
            (SUBLANG_CHINESE_SIMPLIFIED, 0wx02),
            (SUBLANG_CHINESE_HONGKONG, 0wx03),
            (SUBLANG_CHINESE_SINGAPORE, 0wx04),
            (SUBLANG_DUTCH, 0wx01),
            (SUBLANG_DUTCH_BELGIAN, 0wx02),
            (SUBLANG_ENGLISH_US, 0wx01),
            (SUBLANG_ENGLISH_UK, 0wx02),
            (SUBLANG_ENGLISH_AUS, 0wx03),
            (SUBLANG_ENGLISH_CAN, 0wx04),
            (SUBLANG_ENGLISH_NZ, 0wx05),
            (SUBLANG_ENGLISH_EIRE, 0wx06),
            (SUBLANG_ENGLISH_SOUTH_AFRICA, 0wx07),
            (SUBLANG_ENGLISH_JAMAICA, 0wx08),
            (SUBLANG_ENGLISH_CARIBBEAN, 0wx09),
            (SUBLANG_ENGLISH_BELIZE, 0wx0a),
            (SUBLANG_ENGLISH_TRINIDAD, 0wx0b),
            (SUBLANG_FRENCH, 0wx01),
            (SUBLANG_FRENCH_BELGIAN, 0wx02),
            (SUBLANG_FRENCH_CANADIAN, 0wx03),
            (SUBLANG_FRENCH_SWISS, 0wx04),
            (SUBLANG_FRENCH_LUXEMBOURG, 0wx05),
            (SUBLANG_GERMAN, 0wx01),
            (SUBLANG_GERMAN_SWISS, 0wx02),
            (SUBLANG_GERMAN_AUSTRIAN, 0wx03),
            (SUBLANG_GERMAN_LUXEMBOURG, 0wx04),
            (SUBLANG_GERMAN_LIECHTENSTEIN, 0wx05),
            (SUBLANG_ITALIAN, 0wx01),
            (SUBLANG_ITALIAN_SWISS, 0wx02),
            (SUBLANG_KOREAN, 0wx01),
            (SUBLANG_KOREAN_JOHAB, 0wx02),
            (SUBLANG_NORWEGIAN_BOKMAL, 0wx01),
            (SUBLANG_NORWEGIAN_NYNORSK, 0wx02),
            (SUBLANG_PORTUGUESE, 0wx02),
            (SUBLANG_PORTUGUESE_BRAZILIAN, 0wx01),
            (SUBLANG_SERBIAN_LATIN, 0wx02),
            (SUBLANG_SERBIAN_CYRILLIC, 0wx03),
            (SUBLANG_SPANISH, 0wx01),
            (SUBLANG_SPANISH_MEXICAN, 0wx02),
            (SUBLANG_SPANISH_MODERN, 0wx03),
            (SUBLANG_SPANISH_GUATEMALA, 0wx04),
            (SUBLANG_SPANISH_COSTA_RICA, 0wx05),
            (SUBLANG_SPANISH_PANAMA, 0wx06),
            (SUBLANG_SPANISH_DOMINICAN_REPUBLIC, 0wx07),
            (SUBLANG_SPANISH_VENEZUELA, 0wx08),
            (SUBLANG_SPANISH_COLOMBIA, 0wx09),
            (SUBLANG_SPANISH_PERU, 0wx0a),
            (SUBLANG_SPANISH_ARGENTINA, 0wx0b),
            (SUBLANG_SPANISH_ECUADOR, 0wx0c),
            (SUBLANG_SPANISH_CHILE, 0wx0d),
            (SUBLANG_SPANISH_URUGUAY, 0wx0e),
            (SUBLANG_SPANISH_PARAGUAY, 0wx0f),
            (SUBLANG_SPANISH_BOLIVIA, 0wx10),
            (SUBLANG_SPANISH_EL_SALVADOR, 0wx11),
            (SUBLANG_SPANISH_HONDURAS, 0wx12),
            (SUBLANG_SPANISH_NICARAGUA, 0wx13),
            (SUBLANG_SPANISH_PUERTO_RICO, 0wx14),
            (SUBLANG_SWEDISH, 0wx01),
            (SUBLANG_SWEDISH_FINLAND, 0wx02)]
        in
        ...
        local
            fun fromLANGID(MAKELANGID(prim, sub)) =
                Word.toInt(Word.orb(fromPrim prim, Word.<<(fromSub sub, 0w10)))
            (* It seems that GetUserDefaultLangID at least sets the top word
               to something odd so we mask both parts. *)
            fun toLANGID l =
                MAKELANGID(
                    toPrim(Word.andb(Word.fromInt l, 0wx3ff)),
                    toSub(Word.andb(Word.~>>(Word.fromInt l, 0w10), 0wx3f))
                )
